...
\begin{itemize}
  ...
  \item An electronic version of your written hand calcuation.
\end{itemize}
...
Clearly show your forward-sweep in a table that includes all intermediate values.
...
Again, indicate which values are:
\begin{itemize}
  \item newly updated within the current sweep, and
  \item carried over from the previous iteration.
\end{itemize}
