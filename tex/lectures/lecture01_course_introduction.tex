...
\title[MMAE 350]{MMAE 350 --- Computational Mechanics}
...
\begin{frame}
  \titlepage
  \note{
Welcome to MMAE 350. I’m Mike Gosz, and I’m excited to work with you this semester.
...
\begin{columns}[T]
  ...
  \begin{column}{0.45\textwidth}
    \centering
    \includegraphics[width=\linewidth]{chap01_fig04_three-surfaces.png}
    \vspace{0.5em}
...
\vspace{0.5em}
\textbf{No prior Python experience is required.}
